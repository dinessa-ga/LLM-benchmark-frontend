...
class FreeCourse extends CourseCard {
  ...
  render() {
      return `<div class="course-card free-course">
                  <h3>${this.title}</h3>
...
class PremiumCourse extends CourseCard {
  ...
  render() {
      return `<div class="course-card premium-course">
                  <h3>${this.title}</h3>
                  <p>${this.description}</p>
                  <p>Instructor: ${this.instructor}</p>
...
class PromoCourse extends CourseCard {
  ...
  render() {
      ...
      return `<div class="course-card promo-course">
                  <h3>${this.title}</h3>
                  <p>${this.description}</p>
                  <p>Instructor: ${this.instructor}</p>
                  <p>Original Price: $${this.price.toFixed(2)}</p>
                  <p>Discounted Price: $${discountedPrice.toFixed(2)} (${(this.discount * 100).toFixed(0)}% off)</p>

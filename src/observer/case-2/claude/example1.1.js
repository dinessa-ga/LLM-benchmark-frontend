...
// Observer interface (implicitly implemented by User)
// An observer must implement an 'update' method
...
class User {
   ...
   */
  update(product) {
    console.log(`Hi ${this.name}, the price of ${product.name} has been updated to $${product.price}`);
  }
}
